  ...
  return (
    <div>
      ...
      <div className='flex items-center max-[800px]:flex-col '>
          <div className='flex-1 relative max-[800px]:w-[100%] max-[800px]:mb-[50px]'>
              <Image className="pl-[24px] w-[100%] max-[800px]:pl-[0px]" src="/mytripsdetail.png" alt='gambar' width={714} height={902}></Image>
              <div className='absolute bottom-[0px] pl-[24px] w-[100%] max-[800px]:pl-[0px]'>
                <TripInfo tripInfo={tripData} />
              </div>
          </div>
          <div className="flex-1 relative max-[800px]:w-[100%]">
            {flightInformationChanges.length > 0 ? (
              ...
              <p className='text-[44px] mr-[54px] ml-[61px] font-[700] text-center mb-[56px] max-[580px]:text-[28px]'>Currently, There Are No Informations Changes About The Flight</p>
            )}
          </div>
      </div>
      <Footer />
