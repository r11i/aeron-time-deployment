    ...
    const fetchData = async () => {
      try {    
        ...
        const transformedFlights = flightHistories?.map((flightHistory: any) => ({
          ...
          date: flightHistory.depTime.split('T')[0],
    ...
    <>
        ...
        <div className='flex items-center max-[900px]:flex-col'>
            <div className='flex-1 max-[900px]:w-[100%]'>
                <Image className="pl-[24px] w-[100%] h-[100%] max-[900px]:pl-[0px]" src="/mytripshistory.png" alt='gambar' width={714} height={902}></Image>
            </div>
            <div className="flex-1 relative max-[900px]:w-[100%] max-[900px]:mt-[40px]">
              {flights.length > 0 ? (
                <ScrollBarContainer content={<TripHistoryList flightHistory={flights} />} className='mx-auto w-[100%] max-[1372px]:max-h-[600px] max-[984px]:max-h-[400px] max-[900px]:max-h-[600px]' />
              ) : (
