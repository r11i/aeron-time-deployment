  ...
  return (
    <div style={{ minHeight: '100vh', overflow: 'hidden' }}>
        ...
        <fieldset style={{borderTop: '2px solid #76B3DD'}} className='px-[183px] py-[70px] max-[815px]:px-[90px] max-[815px]:py-[35px] max-[633px]:px-[25px] max-[633px]:py-[17px]'>
            <legend  className='m-auto pl-[5%] pr-[5%] text-[36px] font-[700] max-[815px]:text-[24px]'>Register A Flight</legend>
                <InputField className="mb-[27px]" inputClass='max-[633px]:px-[10px] ' placeholder="Input your flight code..." label="Flight Code" value={flightCode} onChange={handleFlightCodeChange}/>
                <InputField className="mb-[27px]" inputClass='max-[633px]:px-[10px] ' placeholder="Input your airline..." label="Airline" value={airline} onChange={handleAirlineChange}/>
                <InputField className="mb-[27px]" inputClass='max-[633px]:px-[10px] ' placeholder="Input your booking code..." label="Booking Code" value={bookingCode} onChange={handleBookingCodeChange}/>
                ...
                <div className='flex justify-end flex-wrap max-[633px]:flex-col'>
                    ...
                    <Button className='border-solid border-black border-[1px] bg-[#2D2F3D] text-white font-bold w-[208px] max-[633px]:w-[140px] max-[633px]:right-[0]' label='Add To MyTrips' onClick={handleAddToMyTrips}></Button>   
                    </div>
                </div>
        </fieldset>
        <Footer></Footer>
