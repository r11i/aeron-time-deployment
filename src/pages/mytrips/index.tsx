  ...
  return (
    <>
      ...
      <div className='flex items-center max-[900px]:flex-col'>
        <div className='flex-1 max-[900px]:w-[100%]'>
          <Image className="pl-[24px] w-[100%] max-[900px]:pl-[0px]" src="/mytrips-1.png" alt='gambar' width={714} height={902}></Image>
        </div>
        <div className="flex-1 relative max-[900px]:w-[100%]  max-[900px]:mt-[40px]">
          <p className='text-[44px] mr-[54px] ml-[61px] font-[700] text-center mb-[56px] max-[951px]:text-[30px] max-[830px]:mb-[28px]'>Currently, You Do Not Have Any Trip Going On</p>
          <div className='px-auto flex w-[100%] justify-center max-[830px]:justify-evenly max-[412px]:flex-col'>
            <div className='max-[412px]:flex max-[412px]:justify-center'>
              <Link href={'/mytrips/register'} className='relative max-[412px]:w-[50%] max-[412px]:mb-[20px]'>
                <Button label='Register A Flight' className='bg-[#2D2F3D] text-white font-[700] mr-[33px] max-[830px]:px-[16px] max-[830px]:py-[7px] max-[830px]:mr-[20px]  max-[830px]:w-[100%] '></Button>
              </Link>
            </div>
            <div className='max-[412px]:flex max-[412px]:justify-center'>
              <Link href={'/mytrips/history'} className='max-[412px]:w-[50%]'>
                <Button label='View My Flight History' className='border-[#2D2F3D] border-[3px] border-solid max-[830px]:px-[16px]  max-[830px]:py-[7px] max-[830px]:w-[100%]'></Button>
              </Link>  
            </div>            
          </div>
        </div>
